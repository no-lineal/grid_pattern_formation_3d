...
class GridScorer(object):
  ...
  def calculate_sac(self, seq1):
    ...
    def filter3(b, x):
      ...
      stencil = np.rot90(b, 3)

      return scipy.signal.convolve(x, stencil, mode='full')
    ...
    seq1_x_seq2 = filter3(seq1, seq2)

    sum_seq1 = filter3(seq1, ones_seq2)
    sum_seq2 = filter3(ones_seq1, seq2)

    sum_seq1_sq = filter3(seq1_sq, ones_seq2)
    sum_seq2_sq = filter3(ones_seq1, seq2_sq)

    n_bins = filter3(ones_seq1, ones_seq2)
